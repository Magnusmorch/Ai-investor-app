...
st.title("AI-basert investeringsassistent – Multi-Aksje")
st.markdown("Velg en gruppe aksjer, og la AI velge den mest lønnsomme for investering.")

assets = st.multiselect("Velg aksjer/krypto du vil analysere", 
                        ["BTC-USD", "AAPL", "MSFT", "TSLA", "AMZN", "NVDA"],
                        default=["BTC-USD", "AAPL", "MSFT"])
